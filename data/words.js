// Original Wordle answers (~2309 words) + known NYT additions
// NYT has been adding words since taking over, so this list gets updated as we discover missing words

export const wordleWords = [
  // Known NYT additions (words that weren't in original list but have been answers)
  "gizmo", "guano", "balsa", "retro", "karma",
  
  // Original Wordle answer list (alphabetical)
  ...
  "artsy", "ascot", "ashen", "aside", "asset", "atoll", "atone", "attic", "audio", "audit",
  ...
  "bleep", "blend", "bless", "blimp", "blind", "blini", "blink", "bliss", "blitz", "bloat",
  "block", "bloke", "blond", "blood", "bloom", "blown", "blues", "bluff", "blunt", "blurb",
  "blurt", "blush", "board", "boast", "bobby", "boded", "bogey", "boggy", "bogie", "bongo",
  "bonus", "booby", "boost", "booth", "booty", "booze", "boozy", "borax", "borer", "borne",
  ...
  "chide", "chief", "child", "chili", "chill", "chimp", "china", "chirp", "chock", "choir",
  ...
  "clown", "clubs", "cluck", "clued", "clump", "clung", "coach", "coast", "cobra", "cocoa",
  "colon", "color", "comet", "comfy", "comic", "comma", "conch", "condo", "conic", "copse",
  "coral", "corer", "corny", "couch", "cough", "could", "count", "coupe", "court", "couth",
  "cover", "covet", "covey", "cower", "coyly", "cozen", "crack", "craft", "cramp", "crane",
  "crank", "crash", "crass", "crate", "crave", "crawl", "craze", "crazy", "creak", "cream",
  "credo", "creed", "creek", "creep", "creme", "crepe", "crept", "crest", "crick", "cried",
  ...
  "daunt", "dealt", "death", "debar", "debut", "decal", "decay", "decor", "decoy", "decry",
  "defer", "deity", "delay", "delta", "delve", "demon", "demur", "denim", "dense", "depot",
  "depth", "derby", "desk", "deter", "detox", "deuce", "devil", "diary", "dicey", "digit",
  ...
  "droop", "dross", "drove", "drown", "drugs", "druid", "drunk", "dryer", "dryly", "duchy",
  "dully", "dummy", "dumpy", "dunce", "dune", "dusty", "dutch", "duvet", "dwarf", "dwell",
  ...
  "extol", "extra", "exude", "exult", "eying", "fable", "facet", "faint", "fairy", "faith",
  "false", "famed", "fancy", "fanny", "farce", "fatal", "fatty", "fault", "fauna", "favor",
  "feast", "feat", "fecal", "feign", "fella", "felon", "femme", "femur", "fence", "feral",
  "ferry", "fetal", "fetch", "fetid", "fetus", "fever", "fewer", "fiber", "ficus", "field",
  "fiend", "fiery", "fifth", "fifty", "filmy", "filth", "final", "finch", "finer", "first",
  "fishy", "fixer", "fizzy", "fjord", "flack", "flail", "flair", "flake", "flaky", "flame",
  "flank", "flare", "flash", "flask", "flats", "fleck", "flesh", "flick", "flier", "fling",
  "flint", "flip", "flirt", "float", "flock", "flood", "floor", "flop", "flora", "floss",
  "flour", "flout", "flown", "fluff", "fluid", "fluke", "flung", "flunk", "flush", "flute",
  "foamy", "focal", "focus", "foggy", "foist", "folio", "folly", "foray", "force", "forge",
  "forgo", "forte", "forth", "forty", "forum", "fossil", "foster", "found", "fount", "fourth",
  "fowl", "foyer", "frail", "frame", "frank", "fraud", "freak", "freed", "freer", "fresh",
  "friar", "fried", "frill", "frisk", "fritz", "frizz", "frock", "frond", "front", "frost",
  "froth", "frown", "froze", "fruit", "fudge", "fugue", "fully", "fumed", "fungi", "funky",
  "funny", "furor", "furry", "fussy", "fusty", "fuzzy", "gaffe", "gaily", "gamer", "gamma",
  "gamut", "gassy", "gauge", "gaunt", "gauze", "gauzy", "gavel", "gawky", "gazer", "gear",
  "gecko", "geeky", "geese", "genie", "genre", "ghost", "giant", "giddy", "girth", "given",
  "giver", "glade", "gland", "glare", "glass", "glaze", "gleam", "glean", "glebe", "glee",
  "glide", "glint", "gloat", "globe", "gloom", "glory", "gloss", "glove", "glow", "glued",
  "gluey", "glyph", "gnarly", "gnash", "gnome", "goat", "godly", "going", "golem", "golly",
  "gonad", "goner", "gooey", "goofy", "goose", "gorge", "gouge", "gourd", "grace", "grade",
  "graft", "grail", "grain", "grand", "grant", "grape", "graph", "grasp", "grass", "grate",
  "grave", "gravy", "graze", "great", "greed", "green", "greet", "grief", "grill", "grime",
  "grimy", "grind", "gripe", "groan", "groat", "groin", "groom", "grope", "gross", "group",
  "grout", "grove", "growl", "grown", "gruel", "gruff", "grump", "grunt", "guard", "guava",
  "guess", "guest", "guide", "guild", "guile", "guilt", "guise", "gulch", "gummy", "guppy",
  "gusto", "gusty", "gutter", "guys", "gypsy", "habit", "hairy", "halve", "handy", "happy",
  "hardy", "harem", "harpy", "harry", "harsh", "haste", "hasty", "hatch", "hater", "haunt",
  "haven", "havoc", "hazel", "head", "heady", "heard", "heart", "heath", "heave", "heavy",
  "hedge", "heedy", "hefty", "heist", "helix", "hello", "hence", "henna", "herbs", "heron",
  "hilly", "hind", "hinge", "hippo", "hippy", "hitch", "hoard", "hobby", "hoist", "holly",
  "homer", "honey", "honor", "hoot", "hoped", "horde", "horn", "horny", "horse", "hotel",
  "hound", "house", "hovel", "hover", "howdy", "hubby", "human", "humid", "humor", "humph",
  "humus", "hunch", "hunky", "hurry", "hurt", "husky", "hussy", "hutch", "hydra", "hyena",
  ...
  "jenny", "jerky", "jest", "jewel", "jiffy", "jilt", "jimmy", "jinks", "jive", "joint",
  "joist", "joker", "jolly", "joust", "judge", "juice", "juicy", "jumbo", "jumpy", "junco",
  "juror", "kappa", "kayak", "kebab", "khaki", "kinky", "kiosk", "kitty", "knack", "knave",
  ...
  "lupus", "lurch", "lurid", "lusty", "lying", "lymph", "lyric", "macaw", "macho", "macro",
  ...
  "might", "milky", "mimic", "mince", "mindy", "miner", "minim", "minor", "minty", "minus",
  ...
  "newly", "nicer", "niche", "niece", "night", "nimby", "ninja", "ninny", "ninth", "nitty",
  "noble", "nobly", "noise", "noisy", "nomad", "noose", "north", "notch", "noted", "novel",
  "nudge", "nurse", "nutty", "nylon", "nymph", "oaken", "oakum", "oasis", "ocean", "octet",
  "ocular", "oddly", "offal", "offer", "often", "ogle", "olive", "ombre", "omega", "onset",
  "opera", "optic", "orbit", "order", "organ", "other", "otter", "ought", "ounce", "outdo",
  "outer", "outgo", "ovary", "ovate", "overt", "ovoid", "owing", "owner", "oxide", "ozone",
  "paddy", "pagan", "paint", "paler", "palsy", "panel", "panic", "pansy", "papal", "paper",
  "parer", "paris", "parka", "parry", "parse", "party", "pasta", "paste", "pasty", "patch",
  "patio", "patsy", "patty", "pause", "payee", "payer", "peace", "peach", "pearl", "pecan",
  "pedal", "penal", "pence", "penny", "perch", "peril", "perky", "pesky", "petal", "petty",
  "phase", "phone", "phony", "photo", "piano", "picky", "piece", "piety", "piggy", "pilot",
  "pinch", "piney", "pinky", "pinto", "pious", "piper", "pique", "pitch", "pithy", "piton",
  "pivot", "pixel", "pixie", "pizza", "place", "plaid", "plain", "plait", "plane", "plank",
  "plant", "plate", "plaza", "plead", "pleat", "plied", "plier", "plod", "plop", "plot",
  "pluck", "plumb", "plume", "plump", "plunk", "plush", "poach", "point", "poise", "poker",
  ...
  "pubic", "pudgy", "pulse", "punch", "pupal", "pupil", "puppy", "puree", "purer", "purge",
  ...
  "racer", "radar", "radii", "radio", "radon", "rafts", "rainy", "raise", "rally", "ralph",
  "ramen", "ranch", "randy", "range", "rapid", "rarer", "raspy", "ratio", "ratty", "raven",
  "rayon", "razor", "reach", "react", "ready", "realm", "reams", "rebel", "rebut", "recap",
  "recur", "recut", "reedy", "refer", "regal", "rehab", "reign", "relax", "relay", "relic",
  ...
  "roomy", "roost", "roots", "rosy", "rouge", "rough", "round", "rouse", "route", "rover",
  "rowdy", "rower", "royal", "ruddy", "ruder", "rugby", "ruin", "ruler", "rumba", "rumor",
  "rupee", "rural", "rusty", "sable", "sabre", "saint", "salad", "sally", "salon", "salsa",
  ...
  "scrap", "scree", "screw", "scrub", "seamy", "sedan", "seedy", "segue", "seize", "semen",
  ...
  "sheet", "shelf", "shell", "shift", "shine", "shiny", "shire", "shirk", "shirt", "shoal",
  "shock", "shone", "shook", "shoot", "shore", "shorn", "short", "shout", "shove", "shown",
  "showy", "shrub", "shrug", "shuck", "shunt", "shush", "shut", "sided", "sidle", "siege",
  "sight", "sigma", "silky", "silly", "since", "sinew", "singe", "siren", "sissy", "sixth",
  "sixty", "skate", "skeet", "skein", "skier", "skiff", "skill", "skimp", "skirt", "skulk",
  ...
  "smoke", "smoky", "smote", "snack", "snafu", "snail", "snake", "snaky", "snap", "snare",
  "snarl", "sneak", "sneer", "snide", "sniff", "snipe", "snoop", "snore", "snort", "snout",
  "snowy", "snuck", "snuff", "soapy", "sober", "soggy", "solar", "solid", "solve", "sonar",
  "sonic", "sooth", "sooty", "sorry", "sorts", "sound", "south", "space", "spade", "spank",
  "spare", "spark", "spasm", "spawn", "speak", "spear", "speck", "speed", "spell", "spend",
  "spent", "spice", "spicy", "spider", "spied", "spiel", "spike", "spiky", "spill", "spine",
  "spiny", "spiral", "spite", "splat", "split", "spoke", "spoof", "spook", "spool", "spoon",
  "spore", "sport", "spout", "spray", "spree", "sprig", "spry", "spud", "spunk", "spurn",
  ...
  "steep", "steer", "stein", "stem", "step", "stern", "stick", "stiff", "still", "stilt",
  ...
  "taker", "talon", "tamer", "tango", "tangy", "taper", "tapir", "tardy", "tarot", "taste",
  "tasty", "tatty", "taunt", "tawny", "teach", "teary", "tease", "teddy", "teeth", "tempo",
  "tenet", "tenor", "tense", "tenth", "tepee", "tepid", "terms", "terra", "terse", "testy",
  ...
  "titan", "title", "toast", "today", "toddy", "token", "tonal", "toner", "tonic", "tooth",
  "topaz", "topic", "torch", "torso", "torus", "total", "totem", "touch", "tough", "towel",
  "tower", "toxic", "trace", "track", "tract", "trade", "trail", "train", "trait", "tramp",
  "trash", "trawl", "tread", "treat", "trend", "triad", "trial", "tribe", "trick", "tried",
  "trier", "trill", "tripe", "trite", "troll", "tromp", "troop", "trope", "troth", "trout",
  "trove", "truce", "truck", "truer", "truly", "trump", "trunk", "truss", "trust", "truth",
  "tryst", "tubal", "tuber", "tulip", "tulle", "tumor", "tuner", "tunic", "turbo", "tutor",
  ...
  "verso", "verve", "vicar", "video", "vigil", "vigor", "villa", "vine", "vinyl", "viola",
  "viper", "viral", "virus", "visit", "visor", "vista", "vital", "vivid", "vixen", "vocal",
  "vodka", "vogue", "voice", "voila", "vomit", "voter", "vouch", "vowel", "vying", "wacky",
  "wade", "wafer", "wager", "wagon", "waist", "waive", "waltz", "warty", "washy", "watch",
  "water", "waver", "waxen", "weary", "weave", "wedge", "weedy", "weigh", "weird", "welch",
  "welsh", "wench", "whack", "whale", "wharf", "wheat", "wheel", "whelp", "where", "which",
  "whiff", "while", "whine", "whiny", "whip", "whirl", "whisk", "white", "whole", "whoop",
  "whose", "widen", "wider", "widow", "width", "wield", "wight", "wily", "wimp", "wince",
  "winch", "windy", "wiper", "wiry", "witch", "withe", "withy", "witty", "woken", "woman",
  ...
  word.length === 5 && self.indexOf(word) === index
).sort();

// Extended word list (valid Wordle guesses that probably won't be answers)
// This is used as a fallback when no common words match
export const extendedWords = [
  // This will be populated with the ~10,000 additional valid guesses
  // For now, just a placeholder - the app will still work, it just won't have the extended fallback yet
];
